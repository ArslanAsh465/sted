...
<div class="d-flex justify-content-between align-items-center mb-4 row">
    <div class="col-md-9">
        <h1 class="h3 mb-0">Add New Institute</h1>
    </div>
</div>
        ...
        <form action="{{ route('admin.institutes.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="principal_name" id="principal_name" value="{{ old('principal_name') }}" 
                       class="form-control @error('principal_name') is-invalid @enderror" required>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="whatsapp_no" id="whatsapp_no" value="{{ old('whatsapp_no') }}" 
            ...
            <button class="btn btn-primary">Create Institute</button>
        </form>
    </div>
</div>
